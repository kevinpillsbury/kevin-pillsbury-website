  ...
  return (
    <DisableScroll>
      <div className="relative h-[calc(100vh-8rem)] overflow-hidden bg-[var(--background)]">
        ...
        <div className="relative z-20 flex items-center justify-center min-h-[calc(100vh-8rem)] px-4 sm:px-6 lg:px-8">
