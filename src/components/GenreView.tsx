  ...
  return (
    <div className="h-full min-h-0 overflow-hidden">
      <div className="grid h-full min-h-0 grid-cols-1 gap-10 md:grid-cols-[240px_minmax(0,1fr)_320px] lg:grid-cols-[260px_minmax(0,1fr)_340px]">
        ...
        {/* Thin divider between titles and content (all writing pages) */}
        <div className="hidden md:flex items-start justify-center">
          <div
            className="w-px bg-[var(--chat-surface)] opacity-85"
            style={{ height: '50vh' }}
            aria-hidden="true"
          />
        </div>
          ...
          <div className="w-full max-w-3xl">
            <div className="h-full min-h-0 overflow-hidden rounded-[3px] border-0 bg-[var(--background)]">
              <div className="h-full min-h-0 overflow-y-auto px-8 py-6 sm:px-10 sm:py-7">
                {selectedComposition ? (
                  <>
                    <h2 className="font-serif text-4xl text-center text-[var(--text)] mb-8">
                      {selectedComposition.title}
                    </h2>
                    <div
                      className={`font-serif text-[var(--muted-text)] text-lg leading-relaxed whitespace-pre-line ${
                  ...
                  <div className="h-full min-h-[240px] flex items-start justify-center pt-10">
                    <p className="font-serif text-lg text-[var(--muted-text)]">
        ...
        <aside className="min-h-0 overflow-hidden">
          <div className="flex h-full min-h-0 flex-col pt-2 gap-2">
            ...
            <p className="shrink-0 text-xs text-[var(--muted-text)] leading-snug pt-1">
