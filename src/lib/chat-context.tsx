...
export function ChatProvider({ children }: { children: ReactNode }) {
  ...
  const ensureGreeting = useCallback(async () => {
    ...
    const prompt =
      "Greet the user and introduce yourself. Give an excuse of why Kevin is not available to answer the user's questions. The excuse should be a whimsical activty that Kevin is currently doing. Finally, offer your assistance to answer the user's questions.";
